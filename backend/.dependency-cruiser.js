...
module.exports = {
  forbidden: [
    {
      ...
      from: {
        // Ignore circular dependencies from database entities
        pathNot: '^src/dataBase/entities/.*\\.entity\\.(ts|js)$',
      },
      to: {
        circular: true,
        // Also ignore circular dependencies to database entities
        pathNot: '^src/dataBase/entities/.*\\.entity\\.(ts|js)$',
      },
    },
    {
  ...
  options: {
    ...
    exclude: {
      /* path: an array of regular expressions in strings to match against */
      path: ['migrations', 'node_modules', 'coverage'],
    },
...
// generated: dependency-cruiser@16.10.2 on 2025-05-16T18:19:05.310Z
