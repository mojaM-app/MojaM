...
export const VALIDATOR_SETTINGS: {
  ...
  BULLETIN_TITLE_MAX_LENGTH: number;
  BULLETIN_NUMBER_MAX_LENGTH: number;
  BULLETIN_INTRODUCTION_MAX_LENGTH: number;
  BULLETIN_DAY_SECTION_CONTENT_MAX_LENGTH: number;
} = {
  ...
  BULLETIN_INTRODUCTION_MAX_LENGTH: 8000, // max length for: introduction, tipsForWork, dailyPrayer
  BULLETIN_NUMBER_MAX_LENGTH: 30, // max length for: bulletin number
