import { IAuthModuleBoundary, ILoggerModuleBoundary, INotificationModuleBoundary, IPermissionModuleBoundary, IUserModuleBoundary } from '@core';
import { Container } from 'typedi';
import { AuthModuleBoundary } from '../../modules/auth/auth-module.boundary';
import { LoggerModuleBoundary } from '../../modules/logger/logger-module.boundary';
...
export const registerModules = (): void => {
  ...
  Container.set<ILoggerModuleBoundary>('LOGGER_MODULE', Container.get(LoggerModuleBoundary));
};
