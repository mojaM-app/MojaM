...
export class CreateTableAnnouncements1729890701959 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE `announcement_items` (`Id` varchar(36) NOT NULL, `Content` text NOT NULL, `CreatedAt` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP, `CreatedById` int NOT NULL, `UpdatedAt` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `UpdatedById` int NULL, `AnnouncementId` int NOT NULL, FULLTEXT INDEX `IXD_AnnouncementItem_Content_Fulltext` (`Content`), PRIMARY KEY (`Id`)) ENGINE=InnoDB');
