export const errorKeys = {
  ...
  bulletin: {
    ...
    TaskDescriptionRequired: 'Bulletin_Task_Description_Required',
    InstructionsRequired: 'Bulletin_Instructions_Required',
    QuestionNotFound: 'Bulletin_Question_Not_Found',
    CannotEditAnsweredQuestion: 'Cannot_Edit_Answered_Question',
    UnauthorizedQuestionAccess: 'Unauthorized_Question_Access',
  },
  logs: {},
};
