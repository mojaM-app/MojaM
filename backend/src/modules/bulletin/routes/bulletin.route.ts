...
export class BulletinRoute implements IRoutes {
  public static path = '/api/bulletins';
  ...
  public initializeRoutes(): void {
    ...
    this.router.get(`${BulletinRoute.path}/published`, [setIdentity], this._bulletinController.getPublished);

    // Get specific bulletin
    this.router.get(
      `${BulletinRoute.path}/:id(\\d+)`,
      [setIdentity, requirePermission(user => user.canGetBulletin())],
    ...
    // Publish bulletin
    this.router.post(
      `${BulletinRoute.path}/:id(\\d+)/publish`,
    ...
    this.router.get(
      `${BulletinRoute.path}/:id(\\d+)/pdf`,
      [setIdentity, requirePermission(user => user.canGetBulletin())],
      this._bulletinController.exportToPdf,
    );

    // Download PDF (public access for published bulletins)
    this.router.get(`${BulletinRoute.path}/:id(\\d+)/download`, this._bulletinController.downloadPdf);

    // Get user progress for a bulletin
    this.router.get(
      `${BulletinRoute.path}/:id(\\d+)/progress/:userId(\\d+)`,
      [setIdentity, requirePermission(user => user.canGetBulletin())],
    ...
    // Answer a question
    this.router.post(
      `${BulletinRoute.path}/questions/answers`,
      [
        setIdentity,
        requirePermission(user => user.canAnswerBulletinQuestion()),
    ...
    this.router.get(
      `${BulletinRoute.path}/:id(\\d+)/questions`,
      [setIdentity, requirePermission(user => user.canGetBulletin())],
    ...
    this.router.get(
      `${BulletinRoute.path}/questions/:questionId(\\d+)/answers`,
      [setIdentity, requirePermission(user => user.canGetBulletin())],
